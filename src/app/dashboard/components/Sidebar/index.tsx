...
const Sidebar = () => {
    ...
    return (
        <>
            <button className={`${isSidebarCollapsed ? "block" : "hidden"} fixed z-20 flex flex-row items-center justify-center w-[50px] h-[50px] rounded-full bg-[#A57CCB] bottom-14 sm:bottom-20 right-10 sm:right-20 lg:hidden`}
